...
const EditableImage = ({ src, alt, onSave, className = "" }) => {
  ...
  // Keep local state in sync with parent src
  useEffect(() => {
    setImageUrl(src);
  }, [src]);
  ...
  if (!isAdmin) {
    return (
      <img
        ...
        onError={(e) => {
          e.currentTarget.src =
            "https://placehold.co/200x200?text=Image+Error";
        }}
      />
    );
  }
          ...
          <div className="space-y-6">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-navy-600">
                Upload from your device or use a URL
              </p>
            </div>
                    ...
                    <Fragment>
                      <Upload
                        className={`w-12 h-12 mx-auto mb-4 ${
                          dragActive ? "text-gold-600" : "text-navy-400"
                        }`}
                      />
                      <p className="text-navy-700 font-medium mb-2">
                        {dragActive
              ...
              <div className="mt-4">
                ...
                <div className="relative">
                  <img
                    src={imageUrl}
                    alt="Preview"
                    className="w-full h-40 object-cover rounded-lg border-2 border-navy-200 shadow-sm transition-opacity duration-300"
            ...
            <div className="flex space-x-3 pt-4 border-t border-navy-100">
              <button
                ...
                disabled={
                  uploadMethod === "file" || isUploading || !imageUrl
                }
