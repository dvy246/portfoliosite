/*
  # Create sections table for content persistence

  1. New Tables
    - `sections` - Simple content sections with name/content pairs
...
CREATE POLICY "Public upsert" ON sections FOR INSERT WITH CHECK (true);
CREATE POLICY "Public update" ON sections FOR UPDATE USING (true);
